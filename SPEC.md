...
- 3,050 puzzles: 2,100 real lichess puzzles (CC0; balanced across ratings 600–2000 and themes) plus our own Stockfish-generated ones, each re-verified with a deeper search (`build-puzzles.mjs --verify`)
